...
#in this example, I know I have 10 XML files named "hathi_serial_[1-10].xml", generated by the corresponding Alma publishing profile
#I also know that I want to go through all the files to get data
for ($i=1;$i<11;$i++) {
 $fileinput = "hathi_serial_" . $i . ".xml";
